        ...
        <section>
          ...
          <div className="mt-4">
            ...
            <p className="leading-relaxed">
              ...
              {practiceInfo.address.country}<br />
              E-Mail: <a href={`mailto:${practiceInfo.email}`} className="text-brand hover:underline">{practiceInfo.email}</a><br />
              Telefon: <a href={`tel:${practiceInfo.phone.replace(/\s/g, '')}`} className="text-brand hover:underline">{practiceInfo.phone}</a>
            </p>
          </div>
        </section>
