            ...
            <tr>
              <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  <!-- Header -->
                  <tr>
                    <td style="background-color: #8c836c; padding: 30px 40px; text-align: center;">
                  ...
                  <tr>
                    <td style="padding: 40px;">
                      ...
                      <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 32px;">
                        ...
                        <tr>
                          <td style="padding: 12px 0; border-bottom: 1px solid #e5e5e5;">
                            ...
                            <a href="mailto:${email}" style="color: #8c836c; font-size: 16px; text-decoration: none;">${email}</a>
                          </td>
                        </tr>
                        ${telefon ? `
                        <tr>
                          <td style="padding: 12px 0; border-bottom: 1px solid #e5e5e5;">
                            ...
                            <a href="tel:${telefon}" style="color: #8c836c; font-size: 16px; text-decoration: none;">${telefon}</a>
                          </td>
                        </tr>
                        ` : ''}
                      </table>
                      ...
                      <div style="background-color: #faf8f5; border-radius: 8px; padding: 20px; border-left: 4px solid #8c836c;">
                        <p style="color: #333; font-size: 15px; line-height: 1.7; margin: 0; white-space: pre-wrap;">${nachricht}</p>
                      </div>

                      <!-- Reply Button -->
                      <div style="margin-top: 32px; text-align: center;">
                        <a href="mailto:${email}?subject=Re: Ihre Anfrage bei Hypnose Enza"
                           style="display: inline-block; background-color: #8c836c; color: #ffffff; padding: 14px 32px; border-radius: 50px; text-decoration: none; font-weight: 500; font-size: 15px;">
                          Direkt antworten
                        </a>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td style="background-color: #faf8f5; padding: 24px 40px; text-align: center; border-top: 1px solid #e5e5e5;">
                      <p style="color: #888; font-size: 13px; margin: 0;">
                        ...
                        <a href="https://hypnose-enza.ch" style="color: #8c836c; text-decoration: none;">hypnose-enza.ch</a> gesendet.
                      </p>
                    </td>
                  </tr>
                </table>
