    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0a1628] via-[#1a2d4a] to-[#0a1628]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute -top-1/4 -right-1/4 w-1/2 h-1/2 bg-[#daaf7a]/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 py-20 md:py-32">
        <div className="text-center">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-block px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-[#daaf7a] text-sm font-semibold uppercase tracking-wider">
              {eventDetails.name}
            </span>
          </motion.div>
